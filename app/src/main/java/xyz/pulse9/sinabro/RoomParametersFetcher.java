...
import xyz.pulse9.sinabro.util.AsyncHttpURLConnection;
import xyz.pulse9.sinabro.util.AsyncHttpURLConnection.AsyncHttpEvents;
...
public class RoomParametersFetcher {
  ...
  private void roomHttpResponseParse(String response) {
    ...
    try {
      ...
      iceServers.clear();
      PeerConnection.IceServer temp = new PeerConnection.IceServer("turn:pulse9.xyz:3478?transport=udp", "pulse9", "pulse9");
      PeerConnection.IceServer temp2 = new PeerConnection.IceServer("stun:pulse9.xyz:3478");
      iceServers.add(temp);
      iceServers.add(temp2);
          Log.d(TAG, "CustomTurnServer: " + temp);
          Log.d(TAG, "CustomTurnServer2: " + temp2);
      boolean isTurnPresent = false;
      for (PeerConnection.IceServer server : iceServers) {
        Log.d(TAG, "IceServer: " + server);
        if (server.uri.startsWith("turn:")) {
          isTurnPresent = true;
          Log.d(TAG, "isTurnPresent: " + isTurnPresent);
          break;
        }
      }
...
//        Log.d(TAG, "TurnServer: " + temp);
      ...
      Log.d(TAG, "ICESERVERS ADDED : " + iceServers.toString());
  ...
  private LinkedList<PeerConnection.IceServer> requestTurnServers(String url)
    ...
    connection.setRequestProperty("REFERER", "https://apprtcv3.appspot.com");
